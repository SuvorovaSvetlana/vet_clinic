...
exports.VisitModule = VisitModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([visit_entity_1.Visit]), typeorm_1.TypeOrmModule.forFeature([visit_repository_1.VisitRepository])],
        controllers: [visit_controller_1.VisitController],
        providers: [visit_service_1.VisitService, visit_repository_1.VisitRepository],
    })
], VisitModule);
